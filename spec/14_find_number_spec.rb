...
describe FindNumber do
  ...
  describe '#make_guess' do
    ...
    subject(:game_guessing0) { described_class.new(5, 9, number_guessing) }
    context 'when min is 5 and max is 9' do
      it 'returns 7' do
        guess = game_guessing0.make_guess
        expect(guess).to eq(7)
      end
    end
    
    subject(:game_guessing1) { described_class.new(8, 9, number_guessing) }
  ...
  describe '#game_over?' do
    context 'when guess and random_number are equal' do
      ...
      let(:number_guessed) { double('number_guessed', value: 8) }

      subject(:game_guessed) { described_class.new(0, 9, number_guessed, 8) }
    ...
    context 'when guess and random_number are not equal' do
      let(:number_not_guessed) { double('number_not_guessed', value: 6) }
      subject(:game_not_guessed) { described_class.new(0, 9, number_not_guessed, 8) }
      it 'is not game over' do
        result = game_not_guessed.game_over?
